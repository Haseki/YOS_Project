                    ...
                    <div id="signup-box" class="signup-box visible widget-box no-border">
                        <div class="widget-body">
                            <div class="widget-main">
                                ...
                                <form method="POST" action="change_admin_action.php" role="form">
                                    <fieldset>
                                        <label class="block clearfix">
                                            <span class="block input-icon input-icon-right">
                                                <input type="hidden" name="id" value="<?php echo $id;?>"></input>
                                                <input type="email" name="post-email"class="form-control" placeholder="Email" value="<?php echo $email;?>" />
                                                <i class="ace-icon fa fa-envelope"></i>
                                            </span>
                                        </label>
                                        <label class="block clearfix">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" name="post-username" class="form-control" placeholder="Kullanıcı Adı" value="<?php echo $name;?>"/>
