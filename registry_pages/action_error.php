                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div id="step-5">
                                                                            ...
                                                                            <div class="alert alert-danger center">
                                                                               <h4>Üzgünüz! (<?php echo $error;?>) hatayla karşılaşıldı. Lütfen tekrar deneyiniz. Eğer yine sorunla karşılaşırsanız şu adrese mail atınız: yavuz.yildiz@erdogan.edu.tr</h4>
                                                                               <h4>Sorry! We have encounter (<?php echo $error;?>) error. Please try again. If you encounter an error again please contact : yavuz.yildiz@erdogan.edu.tr</h4>
                                                                            </div>
