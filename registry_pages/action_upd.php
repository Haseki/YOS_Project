...
if ($error == 0) {
    ...
    updateRegistry($receipt_date, $passport, $tc_no, $name, $surname, $gender, $m_name, $f_name, $birth_plc, $birth_date, $nation, $photo_dir, $gradu_date, $hs_name, $hs_country, $dip_grade, $grade_system, $period, $country, $city, $adres, $tel, $mail, $time ,$ip,$code ,$status);
