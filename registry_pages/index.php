                                                    ...
                                                    <div class="main-container">
                                                        ...
                                                        <div class="panel panel-default">
                                                            <div class="panel-body">
                                                                <form action="action.php" role="form" class="smart-wizard form-horizontal" id="form" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div id="wizard" class="swMain">
                                                                        ...
                                                                        <div id="step-0">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control input-mask-date" id="postReceiptDate" name="postReceiptDate" placeholder="Ay/Gün/Yıl formatında giriniz. (Please fill mm/dd/YYYY formatting)...">
                                                                                </div>
                                                                            </div>
                                                                            <!--<div class="form-group">
                                                                                    <label class="col-sm-3 control-label">
                                                                        ...
                                                                        <div id="step-1">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postPasaport" name="postPassport" placeholder="Pasaport No...">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postKimlik" name="postKimlik" placeholder="TC Kimlik No...">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postName" name="postName" placeholder="Adınız(Your Name)...">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postSurname" name="postSurname" placeholder="Soyadınız(Surname)...">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <label class="radio-inline">
                                                                                        <input type="radio" class="grey" value="f" name="postGender" checked>
                                                                                            Kız (Female)
                                                                                    </label>
                                                                                    <label class="radio-inline">
                                                                                        <input type="radio" class="grey" value="m" name="postGender">
                                                                                            Erkek (Male)
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postMother" name="postMother" placeholder="Anne Adınız (Your Mother Name)...">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postFather" name="postFather" placeholder="Baba Adınız (Your Father Name)...">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postBirthPlace" name="postBirthPlace" placeholder="Doğum Yeriniz (Birth Place)...">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control input-mask-date" id="postBirthDate" name="postBirthDate" placeholder="Ay/Gün/Yıl formatında giriniz. (Please fill mm/dd/YYYY formatting)...">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                        ...
                                                                        <div id="step-2">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control input-mask-date" id="postLiseGraduateDate" name="postGraduDate" placeholder="Ay/Gün/Yıl formatında giriniz. (Please fill mm/dd/YYYY formatting)...">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postLiseName" name="postHighSchName" placeholder="Lisenin Adı (Name of the High School)..">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postLiseCity" name="postHighSchCity" placeholder="Lisenin bulunduğu ülke/şehir (Country-City of the High School)..">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postDegree" name="postDegree" placeholder="Diploma Notu (Diploma Grade)">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postGradeSystem" name="postGradeSystem" placeholder="Not Sistemi (Grading System)">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postTotal" name="postPeriod" placeholder="Toplam Eğitim Süresi (Total Period of Study)">
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div id="step-3">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postCity" name="postCity" placeholder="Şehir (City)..">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-sm-3 control-label">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postAdres" name="postAdress" placeholder="Address..">
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div id="step-4">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="postPhone" name="postPhone" placeholder="Telefon (Phone)..">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <input type="email" class="form-control" id="postMail" name="postMail" placeholder="E-Mail (Mail Address)">
                                                                                </div>
                                                                            </div>
